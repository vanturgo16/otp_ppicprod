    ...
    public function print($id)
    {
        ...
        $packingListDetails = DB::table('delivery_note_details')
            ...
            ->leftJoin('master_units', function ($join) {
                $join->on('master_units.id', '=', DB::raw('COALESCE(master_product_fgs.id_master_units, master_wips.id_master_units, master_tool_auxiliaries.id_master_units, master_raw_materials.id_master_units, sales_orders.id_master_units)'));
            })
