                    ...
                    <div class="col-sm-12">
                            <div class="mt-4 mt-lg-0">
                                    ...
                                    <div class="row mb-4 field-wrapper">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" name="po_number" class="form-control" value="{{ $data->po_number }}" readonly>
                                        </div>
                                    </div>
                                ...
                                @foreach ($data_detail_rm as $data)
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <a href="/edit-grn-item-smt-po/{{ $data->id; }}">
                                                        <button type="button" class="btn btn-sm btn-info">confirm qty <i class="bx bx-edit-alt" title="edit data"></i></button>
                                                    </a></center></td>
