<!-- resources/views/warehouse/action_buttons.blade.php -->
<div class="btn-group" role="group" aria-label="Action Buttons">
    ...
    <form action="{{ route('packing-list.post', $data->id) }}" method="post" class="d-inline" data-id="">
        @method('PUT')
        @csrf
    ...
    <form action="{{ route('packing-list.unpost', $data->id) }}" method="post" class="d-inline" data-id="">
        @method('PUT')
        @csrf
